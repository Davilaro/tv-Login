...
class AuthenticationRepositoryImpl implements AuthenticationRepository {
  ...
  Future<Either<SignInFailure, User>> signIn(
    String username,
    String password,
    //Inicio de sesion simulado---Ahora integrado con la api
  ) async {
    final requestTokenResult = await _authenticationAPI.createRequestToken(); // Paso 2 agregamos el metodo createRequestToken()
